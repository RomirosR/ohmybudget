...
// Форматируем только число (без валюты): группировка разрядов, до 2 знаков
// дробной части (копейки не отбрасываются). Знак белорусского рубля
// добавляется отдельно компонентом RubleSign, т.к. у него нет своего символа
// в Unicode и Intl его выдать не может.
